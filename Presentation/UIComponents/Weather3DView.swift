...
//
//        let moonScale = SIMD3<Float>(repeating: 0.00009)
//        whiteHemisphere.scale = moonScale
//        blackHemisphere.scale = moonScale
//
//        blackHemisphere.orientation = simd_quatf(angle: -.pi/2, axis: SIMD3<Float>(1, 0, 0))
//        whiteHemisphere.orientation = simd_quatf(angle: .pi/2, axis: SIMD3<Float>(1, 0, 0))
//        let bounds = whiteHemisphere.visualBounds(relativeTo: nil)
//        let halfDepth = bounds.extents.z / 2
//
//        whiteHemisphere.position = SIMD3<Float>(0, 0.1, 0)
//        blackHemisphere.position = SIMD3<Float>(0, 0, 0)
//
...
//    }
    ...
    private func loadMoon() -> ModelEntity? {
        ...
        let moonScale = SIMD3<Float>(repeating: 0.00020)
        whiteHemisphere.transform.scale = moonScale
        blackHemisphere.transform.scale = moonScale

        blackHemisphere.orientation = simd_quatf(
            angle: -.pi ,
            axis: SIMD3<Float>(1, 0, 0)
        )

        whiteHemisphere.position = [0, -0.0437, 0]
        blackHemisphere.position = [0, +0.0437, 0]
